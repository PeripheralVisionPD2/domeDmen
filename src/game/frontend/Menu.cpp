...
namespace YimMenu
{
	...
	void Menu::SetupStyle()
	{
		...
		style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.87f, 0.53f, 0.46f, 0.75f);
		style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.8f, 0.34f, 0.21f, 0.85f);

		style.Colors[ImGuiCol_Button] = ImVec4(0.92f, 0.28f, 0.15f, 1.00f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.92f, 0.28f, 0.15f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.92f, 0.28f, 0.15f, 1.00f);
		...
		style.Colors[ImGuiCol_Tab] = ImVec4(0.92f, 0.28f, 0.15f, 0.85f);
		style.Colors[ImGuiCol_TabHovered] = ImVec4(0.92f, 0.28f, 0.15f, 0.85f);
		style.Colors[ImGuiCol_TabActive] = ImVec4(0.92f, 0.28f, 0.15f, 1.00f);

		style.Colors[ImGuiCol_Header] = ImVec4(0.87f, 0.53f, 0.46f, 1.00f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.87f, 0.53f, 0.46f, 1.00f);
		style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.8f, 0.34f, 0.21f, 1.00f);
		...
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.85f, 0.3f, 0.2f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.85f, 0.3f, 0.2f, 1.00f);
	...
	{
		auto& IO = ImGui::GetIO();
		auto file_path = std::filesystem::path(std::getenv("appdata")) / "domeMenV1" / "imgui.ini";
